...
module.exports = (function() {
  var QueryGenerator = {
    ...
    showSchemasQuery: function() {
      return "SELECT schema_name FROM information_schema.schemata WHERE schema_name <> 'information_schema' AND schema_name != 'client' AND schema_name !~ E'^pg_';";
    },
    ...
    showTablesQuery: function() {
      return "SELECT table_name FROM information_schema.tables WHERE table_schema = 'client';";
    },
    ...
    pgListEnums: function(tableName, attrName, options) {
      ...
      var query = 'SELECT t.typname enum_name, array_agg(e.enumlabel) enum_value FROM pg_type t ' +
        ...
        'WHERE n.nspname = \'client\' ' + enumName + ' GROUP BY 1';
