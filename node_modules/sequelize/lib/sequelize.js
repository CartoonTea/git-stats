...
module.exports = (function() {
  ...
  */
   ...
   * @param {String}                  [options.schema='client']
   ...
   * @param {String} [options.schema='client'] The schema that the tables should be created in. This can be overriden for each table in sequelize.define
   * @return {Promise}
   */
